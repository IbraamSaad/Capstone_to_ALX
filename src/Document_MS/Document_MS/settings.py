"""
Django settings for Document_MS project.
...
SECRET_KEY = 'django-insecure-h0atpeu0b)@dn3ffwbhik5pv_2w5v!)7-dy)_q0wbywd5^(a!%o%d'
...
WSGI_APPLICATION = 'Document_MS.wsgi.application'
